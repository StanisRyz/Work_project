...
- RT-1 deliberately excludes Redis, the SSE endpoint, `EventSource`, partial endpoints, toasts, WebSocket/Channels, polling, an ASGI production server, reverse proxy, event storage in PostgreSQL, and external queues. See `docs/realtime.md`.
