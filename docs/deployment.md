...
`/quality/acts/clear-all/` **не регистрируется**, прямой запрос получает обычный 404.
...
миграции, обязательные справочники, отсутствие
...
real-time с настоящим PING, static/media, demo reset,
