...
журнала принадлежат роли **ПДО** — только она сохраняет расчёт в журнал,
добавляет строки вручную, подтверждает и правит производственные данные и
удаляет строки. Подразделение «Планово-диспетчерская служба» существует
отдельно и само по себе прав не даёт.
